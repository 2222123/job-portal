          ...
          : user && userToken ? (
            <div className='flex items-center gap-3'>
              ...
              <div className='relative group'>
                <button className='bg-gradient-to-r from-indigo-500 via-blue-500 to-teal-500 text-white px-4 py-2 rounded-full shadow-lg hover:shadow-xl focus:outline-none transition duration-300'>
                  Advanced Toolkit ▾
                </button>
                <div className='absolute top-full right-0 mt-2 bg-white shadow-2xl rounded-xl py-2 min-w-[220px] hidden group-hover:block z-50 border border-slate-200'>
